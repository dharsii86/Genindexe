...
public class OrderResearch extends JLabel {
    ...
    //JLabels (declaration and initialisation)
    private final JLabel Titre = new JLabel("Order research", JLabel.CENTER);
    private final JLabel CustomerTown = new JLabel("Customer Town :", JLabel.CENTER);
    private final JLabel CustomerName = new JLabel("Customer Name :", JLabel.CENTER);
    private final JLabel AnalysisName = new JLabel("Analysis Name", JLabel.CENTER);
    private final JLabel OrderStatus = new JLabel("Order Status", JLabel.CENTER);
    private final JLabel SamplesAnalysed = new JLabel("Analysed Samples", JLabel.CENTER);
    private final JLabel Nothing1 = new JLabel();
    private final JLabel Nothing2 = new JLabel();
    private final JLabel Extenser1 = new JLabel();
    private final JLabel Extenser2 = new JLabel();
    ...
    public OrderResearch(MenuWindow screen) {
        ...
        // Management of the container panel
        this.setBackground(Color.WHITE);
        this.setOpaque(true);
        this.setLayout(new GridBagLayout());
        globalScreen = screen;

        // Creation of GridBagConstraints
